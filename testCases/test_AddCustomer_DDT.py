...
class Test_Add_Customer:
    ...
    def test_addCustomer_003(self, setup):
        ...
        if self.ac.Validate_Success_Message() == "pass":
            ...
            allure.attach(self.driver.get_screenshot_as_png(), name="test_user_login_003-Pass",
                          attachment_type=AttachmentType.PNG)

            self.driver.save_screenshot("D:\\Software training\\Automation testing\\Pycharm Projects\\Pyfrmaddingcustnocoms\\Screenshots\\test_addCustomer_003_pass.png")
            assert True
        else:
            allure.attach(self.driver.get_screenshot_as_png(), name="test_user_login_003-fail",
                          attachment_type=AttachmentType.PNG)
